...
space = "         "
lines =  space + "-"*44
apihack = "https://github.com/Jokergazaa{}/?q={}"
mbasic = "https://www.facebook.com/JOGeeR.plstaeeen/{}"
graph = "https://t.me/jokerplstaeen{}"
userrecon_num = 0
userrecon_working = 0
userrecon_results = []
check_email_num = 0
...
logo = f"""{b}
    ...
    / /     \(  )/    -----           
   //////   ' \/ `   ---            ┏───────────────────────────────┓│─┘────────┘─┘──── 
  //// / // :    : ---              │     WELCOME TO collect informations-gaza        │
...
//          //..\\                  │https://t.me/jokerplstaeen                       │
  ...
  {d}Authors: {w}{r}@joker-gaza{d} & {w}{r}@AHM7D-it{w}
"""
...
def menu():
    ...
    print(f"""
        ...
        {w}{b}  01{w} Userrecon     {d} Username reconnaissance - hak-gaza
        {w}{b}  02{w} Facedumper    {d} Dump facebook information - hak-gaza
        {w}{b}  03{w} Mailfinder    {d} Find email with name - hak-gaza
        {w}{b}  04{w} Godorker      {d} Dorking with google search - hak-gaza
        {w}{b}  05{w} Phoneinfo     {d} Phone number information - hak-gaza
        {w}{b}  06{w} DNSLookup     {d} Domain name system lookup - hak-gaza
        {w}{b}  07{w} Whoislookup   {d} Identify who is on domain - hak-gaza
        {w}{b}  08{w} Sublookup     {d} Subnetwork lookup - hak-gaza
        {w}{b}  09{w} Hostfinder    {d} Find host domain - hak-gaza
        {w}{b}  10{w} DNSfinder     {d} Find host domain name system - hak-gaza
        {w}{b}  11{w} RIPlookup     {d} Reverse IP lookup - hak-gaza
        {w}{b}  12{w} IPlocation    {d} IP to location tracker - hak-gaza
        {w}{b}  13{w} Bitly Bypass  {d} Bypass all bitly urls - hak-gaza
        {w}{b}  14{w} Github Lookup {d} Dump GitHub information - hak-gaza
        {w}{b}  15{w} TempMail {d}      Generate Temp Mail and Mail Box - hak-gaza
